    ...
    return (
      <div className="flex flex-col gap-4 animate-in fade-in">
        ...
        <div className="flex flex-col gap-3">
          {voxPops.map((vp, idx) => (
            <div key={idx} className="p-4 rounded-xl border border-zinc-200 bg-zinc-50 flex flex-col sm:flex-row gap-4 items-center">
            ...
            {contrastingCitizens.map((citizen, idx) => {
              ...
              return (
                <div 
                  ...
                  className={`p-4 rounded-xl border-2 transition-all text-center relative overflow-hidden group flex flex-col justify-center h-[180px] ${
                ...
                >
                  ...
                  <div className={`transition-all duration-500 ${isRevealed ? 'opacity-100 transform-none' : 'opacity-0 translate-y-4 hidden'}`}>
                    ...
                    <span className="text-xs text-pink-500 font-bold uppercase tracking-widest block mb-1">Subjective Utility</span>
        ...
        <div className="flex flex-col gap-4 animate-in fade-in">
          ...
          >
            ...
            <div className={`transition-all duration-500 ${revealedEmpathy ? 'opacity-100 transform-none' : 'opacity-0 translate-y-4 hidden'}`}>
              ...
              <p className="text-xs text-zinc-500 mt-3 max-w-sm mx-auto italic leading-relaxed">
