...
export default function D3Chart({ 
  plotType, chartData, histogramData, xAxisType, yAxisType, color, highlightBars, ministers, markers, onHoverMinisters, isStacked, visualStyle = 'faces'
}: D3ChartProps) {
  ...
  }, [plotType, chartData, histogramData, xAxisType, yAxisType, color, ministers, highlightBars, markersJson, isStacked, visualStyle, dimensions]);
