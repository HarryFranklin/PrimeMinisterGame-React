...
export const availablePolicies: Policy[] = [
  ...
  // ==========================================
  {
    ...
    specificRules: [
      ...
      // Models slight tax avoidance / friction in the upper bracket
      { note: "Tax burden on upper half", minLS: 5.0, affectEveryone: false, proportion: 0.90, impact: -0.15 }
    ]
  },
  {
    id: "wealth-tax",
    ...
    specificRules: [
      // Wealth flight and evasion means this doesn't hit 100% of the top bracket
      { note: "Severe penalty to highest LS", minLS: 8.5, affectEveryone: false, proportion: 0.75, impact: -1.1 },
      { note: "Boost to lowest LS", maxLS: 4.5, affectEveryone: false, proportion: 0.90, impact: 1.1 }
    ]
  },
  {
    ...
    specificRules: [
      { note: "Boost to lower-middle", minLS: 2.0, maxLS: 5.5, affectEveryone: false, proportion: 0.65, impact: 1.2 },
      { note: "Profit penalty to top end", minLS: 7.5, affectEveryone: false, proportion: 0.85, impact: -0.6 }
    ]
  },
  {
    ...
    specificRules: [
      { note: "Massive security for lowest LS", maxLS: 3.5, affectEveryone: false, proportion: 0.40, impact: 1.9 },
      { note: "Minor tax penalty to upper-middle", minLS: 6.5, maxLS: 8.5, affectEveryone: false, proportion: 0.95, impact: -0.2 }
    ]
  },
  ...
  },
  {
    ...
    specificRules: [
      { note: "Gains for upper half", minLS: 6.0, affectEveryone: false, proportion: 0.75, impact: 0.9 },
      { note: "Displacement penalty to lowest segment", maxLS: 3.0, affectEveryone: false, proportion: 0.40, impact: -0.4 }
    ]
  },
  {
  ...
  // ==========================================
  {
    ...
    specificRules: [
      ...
      { note: "Minor tax burden on top half", minLS: 6.0, affectEveryone: false, proportion: 0.95, impact: -0.15 }
    ]
  },
  {
    ...
    specificRules: [
      ...
      { note: "Infrastructure drag for the rest", affectEveryone: false, proportion: 0.90, impact: -0.1 }
    ]
  },
  {
  ...
  // ==========================================
  {
    ...
    specificRules: [
      { note: "Cost surge penalty to top", minLS: 7.5, affectEveryone: false, proportion: 0.85, impact: -0.7 },
      { note: "Environmental equity reward for bottom", maxLS: 4.5, affectEveryone: false, proportion: 0.70, impact: 0.4 }
    ]
  },
  {
  ...
  },
  {
    ...
    specificRules: [
      { note: "Loss of prestige events for top", minLS: 8.0, affectEveryone: false, proportion: 0.60, impact: -0.5 },
      { note: "Grassroots access for lower-middle", minLS: 3.0, maxLS: 5.5, affectEveryone: false, proportion: 0.40, impact: 0.6 }
    ]
  },
  {
